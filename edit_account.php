...
<div class="form-group"><!-- form-group Begin -->
                        ...
                        ?>
                               ...
                               <input type="text" class="form-control" name="username" value="<?php echo $c_username?>">
                           ...
                           <div class="form-group"><!-- form-group Begin -->
                               ...
                               <input type="text" class="form-control" name="AGE" value="<?php echo $c_age?>">
                           ...
                           <div class="form-group"><!-- form-group Begin -->
                               ...
                               <input type="text" class="form-control" name="VILLE" value="<?php echo $c_ville?>">
