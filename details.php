		...
		?>       
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
                       ...
                       <div class="box"><!-- box Begin -->
                           ...
                           <form action="checkout.php" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                                    <table width='100%' cellpadding="10px">
                                        ...
                                        <tr>
                                        <td><label >Gategory:</label></td>
                                        <td><a style="color:grey;text-decoration:none;" href="categorie.php?catid=<?php echo $categorie['cat_id'];?>"><?php echo $categorie['cat_title'];?></a></td>
                                        </tr>
                                        <tr>
                                        <td><label >Price:</label></td>
                                        <td><P style="color:grey;text-decoration:none;font-size: 1.9rem;"><?php echo $row['product_price']." DH";?></P></td>
                                        </tr>
                                    </table> 
               ...
               <div class="box" id="details"><!-- box Begin -->
                       ...
                       <h3 align ="center">Products you may like :</h3>
                            ...
                            <div class="product" align="center"><!-- product Begin -->
                                ...
                                <div class="text"><!-- text Begin -->
                                    ...
                                    <p class="button">
                                        ...
                                        <a href="details.php?productid=<?php echo $row['product_id']; ?>" class="btn btn-default">View Details</a>
